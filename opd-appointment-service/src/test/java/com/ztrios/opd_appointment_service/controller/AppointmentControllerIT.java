...
import com.ztrios.opd_appointment_service.testconfig.AbstractPostgresIT;
...
/**
 * Integration tests for Appointment Service controller endpoints.
 * Uses PostgreSQL Testcontainer for realistic database testing.
 */
class AppointmentControllerIT extends AbstractPostgresIT {
    ...
    void health_ShouldReturnUpStatus_WithDatabaseConnected() throws Exception {
        mockMvc.perform(get("/health"))
                ...
                .andExpect(jsonPath("$.service", is("opd-appointment-service")))
